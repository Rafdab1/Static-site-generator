...
class TestHTMLNode(unittest.TestCase):
    ...
    def test_to_html_with_props(self):
        node = LeafNode("p","some text", {"property": "some value"})
        self.assertEqual(node.to_html(),"<p property=\"some value\">some text</p>")
    ...
    def test_LeafNode_repr(self):
        ...
        self.assertEqual(node.__repr__(), f"LeafNode(p, text, None)")
